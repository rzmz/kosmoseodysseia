...
public class Sound
{
    static File sound = new File("Music.wav"); // Write you own file location here and be aware that it needs to be an .wav file
    ...
    static double seconds = 1.0d; // The amount of seconds to wait before the sound starts playing
